function ht = LatexYTickLabel(varargin)

%LATEXYTICKLABELS replaces YTickLabels with "normal" texts
...
% http://fr.mathworks.com/matlabcentral/fileexchange/19062-my-yticklabels-replaces-yticklabels-with--normal--texts-and-resizes-axis-to-fit-the-texts
