function ht = LatexXTickLabel(varargin)

%LATEXXTICKLABEL replaces XTickLabels with "normal" texts
...
% http://fr.mathworks.com/matlabcentral/fileexchange/19059-my-xticklabels
